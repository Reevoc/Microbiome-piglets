...
base_tree_path <- paste0(path_to_data,"/6_tree/tree/")
...
write.csv(as.data.frame(input_matrix_imp$imp_count_mat_origlibsize), file = "/home/microbiome/data/3.1_feature_table_imp/feature_table_imp.csv", row.names = FALSE)
write.csv(as.data.frame(input_matrix_imp$imp_count_mat_lognorm), file = "/home/microbiome/data/3.3_feature_table_imp_lgn/feature_table_imp_lgn.csv", row.names = FALSE)
write.csv(as.data.frame(input_matrix_imp$imp_count_mat_norm), file = "/home/microbiome/data/3.2_feature_table_imp_nrm/feature_table_imp_nrm.csv", row.names = FALSE)
