...
from run import run_metadata, run_normalization, run_ANCOM, run_MASLIN, run_metrics, run_denoising, run_get_infromations, run_intersecate_ANCOM_MaAsLin, run_imputation, run_longitudinal_analysis
...
sh_ancom = "/home/microbiome/docker_app/src/sh/9-diff_abb_ANCOM.sh"
sh_maslin = "/home/microbiome/docker_app/src/sh/10-diff_abb_MaAsLin2.sh"
...
sh_longitudinal_analysis = "/home/microbiome/docker_app/src/sh/12-longitudinal-analysis.sh"
sh_longitudinal_extract = "/home/microbiome/docker_app/src/sh/11-extract-alpha-col.sh"
